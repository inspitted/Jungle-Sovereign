// --- CONFIG DATA ASSETS (SENJATA JUNGLE/PRIMAL TAPI STATS TETEP SAMA) ---
const WEAPONS = [
    { id: 'w1', name: 'Wooden Club', icon: '🪵', req: 1, cost: 50, power: 2, mult: '×2.2' },
    { id: 'w2', name: 'Stone Axe', icon: '🪓', req: 3, cost: 500, power: 10, mult: '×7' },
    { id: 'w3', name: 'Tribal Spear', icon: '🔱', req: 7, cost: 4000, power: 50, mult: '×30' },
    { id: 'w4', name: 'Primal Bow', icon: '🏹', req: 12, cost: 25000, power: 250, mult: '×135' },
    { id: 'w5', name: 'Bone Greatsword', icon: '🦴', req: 20, cost: 150000, power: 1500, mult: '×700' },
    { id: 'w6', name: 'Ancient Totem', icon: '🗿', req: 35, cost: 1000000, power: 10000, mult: '×4000' }
];
